...
public class PersistenciaAvionLivianoSimple {
	@Test
	public void testUnAvionLivianoSimplePodriaPoderSerializarce () throws IOException{
	
		String pathArchivo = "XML\\PersitenciaAvionLivianoSimplePrueba.xml";
        ...
        AvionLiviano avionAPersistir = AvionLiviano.crearAvionLivianoSimple(posicionAPersistir, radioAPersistir, velocidadAPersistir, direccionAPersistir, null);
...
@Test
	public void testUnLivianoSePodriaCrearApartirDeUnArchivoXML() throws IOException, JDOMException
	{
		...
		try {
	        ...
	        avionXML = AvionLiviano.cargarDesdeXML(document.getRootElement(), null);
