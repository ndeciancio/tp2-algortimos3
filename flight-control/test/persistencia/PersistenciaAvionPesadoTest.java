...
public class PersistenciaAvionPesadoTest {
	@Test
	public void testUnAvionLivianoSimplePodriaPoderSerializarce () throws IOException{
	
		String pathArchivo = "XML\\PersitenciaAvionPesadoSimplePrueba.xml";
        ...
        AvionPesado avionAPersistir = AvionPesado.crearAvionPesadoSimple(posicionAPersistir, radioAPersistir, velocidadAPersistir, direccionAPersistir, null);
...
@Test
	...
	{
	AvionPesado avionXML;
		try {
			String pathArchivo = "XML\\PersitenciaAvionPesadoSimplePrueba.xml";
	        SAXBuilder builder = new SAXBuilder();
	        Document document = builder.build(pathArchivo);
	        
	        avionXML = AvionPesado.cargarDesdeXML(document.getRootElement(), null);
	        
		} catch(Exception e) {
			throw new RuntimeException(e);
		}
		
			assertTrue(avionXML instanceof AvionPesado);
